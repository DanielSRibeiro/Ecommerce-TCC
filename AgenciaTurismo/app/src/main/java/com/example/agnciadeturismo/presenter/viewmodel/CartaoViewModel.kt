...
class CartaoViewModel(private val repositoryTask: CartaoRepositoryTask) : ViewModel(){
    ...
    class ViewModelFactory(private val repositoryTask: CartaoRepositoryTask) : ViewModelProvider.Factory {
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            return modelClass.getConstructor(CartaoRepositoryTask::class.java)
