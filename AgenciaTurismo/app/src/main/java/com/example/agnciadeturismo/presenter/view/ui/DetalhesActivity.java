...
public class DetalhesActivity extends AppCompatActivity {
    ...
    private void initView() {
        viewModel = new ViewModelProvider(this, new CidadeViewModel.ViewModelFactory(new CidadeRepositoryTask())).get(CidadeViewModel.class);
    ...
    private void initObserver() {
        viewModel.getNomeOrigem().observe(this, new Observer<String>() {
            @Override
        ...
        viewModel.getNomeDestino().observe(this, new Observer<String>() {
            @Override
            public void onChanged(String response) {
